...
O modo **Chrome local** usa a extensão da pasta `price-monitor-chrome` para pesquisar Google Web, Shopping e Mercado Livre na sessão real do navegador. O painel detecta automaticamente a extensão, acompanha o progresso e mantém a API online como alternativa.
